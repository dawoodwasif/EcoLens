    ...
    return (
      <Header aria-label="IBM Platform Name">
        <HeaderName
          href="#"
          prefix="Eco"
          style={{ paddingRight: '4px' }} // Adjust padding right here
          >
          Lens
        </HeaderName>
        <img src={logo} alt="EcoLens Logo" style={{ height: '24px', width: '48px', marginLeft: '0px' }} />
        ...
        <HeaderNavigation aria-label="IBM [Platform]">
          ...
          { this.state.loggedIn &&
            <HeaderMenu aria-label={messages_en.profileHeaderBtn} menuLinkName="Profile">
              <HeaderMenuItem href="#">Meet others</HeaderMenuItem>
              <HeaderMenuItem href="#">Report a problem</HeaderMenuItem>
